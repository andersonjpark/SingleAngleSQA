...
vector<double> kbar(MATRIX<complex<double>,NF,NF> Hfbar);
...
double f(double x){ return 0.5*x*(1.-0.25*x*(1.-0.5*x*(1.-0.625*x)));}

double g(double x){ return 0.5*x*(1.-0.75*x*(1.-0.83333333*x*(1.-0.875*x)));}
