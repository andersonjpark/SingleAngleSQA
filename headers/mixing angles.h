...
double asymptotictheta(MATRIX<complex<double>,NF,NF> Hf,vector<double> dk);
double asymptoticthetabar(MATRIX<complex<double>,NF,NF> Hf,vector<double> dk);
...
MATRIX<complex<double>,NF,NF> U(vector<double> dk,vector<MATRIX<complex<double>,NF,NF> > &C,vector<vector<double> > A);
MATRIX<complex<double>,NF,NF> U(MATRIX<complex<double>,NF,NF> Hf,vector<double> k,vector<double> dk);
MATRIX<complex<double>,NF,NF> asymptoticU(MATRIX<complex<double>,NF,NF> Hf,vector<double> dk);
void Evaluate_UV(void);

MATRIX<complex<double>,NF,NF> Ustar(MATRIX<complex<double>,NF,NF> Hf,vector<double> k,vector<double> dk);
MATRIX<complex<double>,NF,NF> asymptoticUstar(MATRIX<complex<double>,NF,NF> Hf,vector<double> dk);

void Evaluate_CV(void);
void Evaluate_AV(void);

vector<MATRIX<complex<double>,NF,NF> > CofactorMatrices(MATRIX<complex<double>,NF,NF> H,vector<double> k);
vector<MATRIX<complex<double>,NF,NF> > CofactorMatricesDerivatives(MATRIX<complex<double>,NF,NF> H,MATRIX<complex<double>,NF,NF> dHdr,vector<double> k,vector<double> dkdr);

vector<vector<double> > MixingMatrixFactors(vector<MATRIX<complex<double>,NF,NF> > &C,vector<MATRIX<complex<double>,NF,NF> > &C0,vector<vector<double> > A0);
       ...
       { MATRIX<complex<double>,NF,NF> u;
         ...
         for(int j=0;j<=NF-1;j++)
            { if(j==0){ d=-dk[0];}  // first column 
              ...
              if(r2[e]>=r2[mu]){ u[e][j]=A[j][e]*C[j][e][e]/sqrt(r2[e]);    u[mu][j]=A[j][e]*C[j][e][mu]/sqrt(r2[e]);}
              if(r2[mu]>=r2[e]){ u[e][j]=A[j][mu]*C[j][mu][e]/sqrt(r2[mu]); u[mu][j]=A[j][mu]*C[j][mu][mu]/sqrt(r2[mu]);}
            }
