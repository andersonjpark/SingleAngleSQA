...
*/
vector<double> averageProbability(vector<double> Pe,vector<double> Pebar,vector<double> Pheavy,vector<double> ebarPotentialSum,vector<double> ePotentialSum,vector<double> heavyPotentialSum)
